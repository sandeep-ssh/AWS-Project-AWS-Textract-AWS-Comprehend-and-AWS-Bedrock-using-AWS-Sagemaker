# AWS-Project-AWS-Textract-AWS-Comprehend-and-AWS-Bedrock-using-AWS-Sagemaker
AWS ML Project using Amazon Textract, Amazon Comprehend ,Amazon Bedrock &amp; Amazon Sagemaker
...
Your image or document is stored in a safe place online.



You open your SageMaker notebook — this is your workspace to run the steps.



Textract reads the image and pulls out the words.



Comprehend reads those words and tells you the overall feeling (sentiment).



You view a simple summary and decide what to do next.
...
A lightweight diagram to visualize the flow:
...
[Textract]    [Comprehend]
   |              |
   v              v
[Extracted Text] [Sentiment Result]
        \         /
         v       v
       [Simple Summary for Review]
...
Keep your files organized and clearly named for easier tracking.
